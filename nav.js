...
.sbln-logo { display: flex; align-items: center; gap: 8px; padding-right: 14px; margin-right: 6px; border-right: 1px solid var(--border); white-space: nowrap; text-decoration: none; flex-shrink: 0; }
.sbln-logo img { height: 28px; width: auto; display: block; }
